...
public class PianoView: UIView {
    ...
    let notesWithSharps = ["C", "C#", "D", "D#", "E", "F", "F#", "G", "G#", "A", "A#", "B"]
        ...
        public init(width: Int, height: Int, lowestKey: Int, totalKeys: Int) {
            ...
            let blackFrame = UIView(frame: CGRect(x: 0, y: 0, width: (keyWidth ) * totalKeys , height: (keyWidth ) * totalKeys ))
