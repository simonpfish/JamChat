...
extension AKAudioFile {
    ...
    public func exportFixed(
        ...
        guard   ExportFormatFixed.arrayOfStrings.contains(fromFileExt) else {
    ...
    /// See playground for an example of use.
    ///
    public class ExportSessionFixed {
        ...
        public init(fileName: String, baseDir: BaseDirectory,
                    ...
                    presetName: String,
                    file: AKAudioFile,
                    outputFileExtension: ExportFormatFixed,
                    from inTime: Double,
